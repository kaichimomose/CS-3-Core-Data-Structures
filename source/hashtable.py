...
class HashTable(object):
    ...
    def load_factor(self):
        ...
        quotient = self.size / len(self.buckets)
        return quotient

    def keys(self):
        """Return a list of all keys in this hash table.
        Best and worst case running time: O(n*l) for n bukets in the hash table
        for l items in the list - """
    ...
    def get(self, key):
        ...
        Best case running time: O(1) - first buket first item
        Worst case running time: O(l) for l items in the list - last item"""
        # Find the bucket the given key belongs in
        index = self._bucket_index(key)
        bucket = self.buckets[index]
    ...
    def _resize(self, new_size=None):
        ...
        Best and worst case running time: O(n*l) - get all entries
